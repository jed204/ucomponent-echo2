...
public class WebAssetImageReferencePeer implements PropertyXmlPeer {
	   ...
	   throws InvalidPropertyException {
	       if (propertyElement.hasAttribute("value")) {
	           return new WebAssetImageReference(propertyElement.getAttribute("value"));
	       } else {
	           ...
	           if (!httpImageReferenceElement.hasAttribute("uri")) {
	               throw new InvalidPropertyException("Invalid WebAssetImageReference property (uri not specified).", null);
	           }
